...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected List<LocalMedia> oldSelectionMedias;
    /**
    ...
    private void initConfig() {
        ...
        oldSelectionMedias = config.selectionMedias;
        Log.e("PictureBaseActivity","oldSelectionMedias"+oldSelectionMedias.size());
        if (oldSelectionMedias == null) {
            oldSelectionMedias = new ArrayList<>();
        }
    }
    ...
    protected void onResult(List<LocalMedia> images) {
        ...
        images.addAll(images.size() > 0 ? images.size() - 1 : 0, oldSelectionMedias);
